#pragma checksum "C:\Users\timur\source\repos\ChatApp\ChatApp\Views\Room\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ad0e21239e88da8c5e06d97148de6e331458caa5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ad0e21239e88da8c5e06d97148de6e331458caa5", @"/Views/Room/Index.cshtml")]
...
#line 11 "C:\Users\timur\source\repos\ChatApp\ChatApp\Views\Room\Index.cshtml"
     foreach(var v in Model.UsersInRoom)
        {
            if (Model.RoomAdmins.Contains(v.User))
            {
...
#nullable disable
            ...
            BeginWriteAttribute("id", " id=\"", 401, "\"", 417, 1);
#nullable restore
#line 15 "C:\Users\timur\source\repos\ChatApp\ChatApp\Views\Room\Index.cshtml"
WriteAttributeValue("", 406, v.UserName, 406, 11, false);
...
WriteAttributeValue("", 513, v.UserName, 513, 11, false);
...
#nullable disable
            WriteLiteral("    </div>\r\n</div>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ad0e21239e88da8c5e06d97148de6e331458caa56139", async() => {
            }
            );
...
#nullable disable
            ...
            WriteLiteral(" \r\n\r\n<!--сделать завтра - полное управление комнатой, нормальное изменение пароля-->");
        }
